...
(function () {
    ...
    function injectStyles() {
        ...
        style.textContent = `
            ...
            .mina-agent-avatar img { width: 100%; height: 100%; object-fit: cover; display: block; }
            .mina-agent-text {
            ...
            .mina-agent-btn:hover { transform: translateY(-1px); opacity: 0.85; }
    ...
    function buildWidget() {
        ...
        wrap.innerHTML = `
            ...
            <div class="mina-agent-top">
                <div class="mina-agent-avatar"><img src="img/profile-hero.jpg" alt="Mina"></div>
                <div class="mina-agent-text">Still exploring? Mina is standing by and ready for an interview whenever you are.</div>
            </div>
            <a class="mina-agent-btn" href="main.html#contact">Request Interview →</a>
        `;
